...
// Message Master Filter

Dcl-F MSGMSTFZ workstn infds(dspDs) UsrOpn;

/Copy QSRC,BASFNCV1PR // prototypes for all #$ procedures
/Copy QSRC,APLSRVV1PR // prototypes for $ procedures used for template programs
/Copy QSRC,MSGMSTDZ_@ // auto generatde data structures for field attribute fields
/Copy QSRC,MSGMSTDZPR // Always include the prototype for the current program
/Copy QSRC,DCTVALBPPR
/Copy QSRC,DCTVALDPPR

Dcl-Ds filterDs extname('MSGMSTFZ') Inz End-DS;
