...
// CPP for CPYMSD - Copy Message Desription

// This pulls the current message values and then calls the ADDMSGD
...
Dcl-Proc Main;
  ...
  CMD = '? ADDMSGD MSGF('+%trim(msgLib)+'/'+%trim(msgFle)+')';
