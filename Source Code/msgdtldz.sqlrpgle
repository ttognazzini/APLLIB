...
// Message File Detail - Filter

Dcl-F MSGDTLFZ workstn infds(dspDs) UsrOpn;

/Copy QSRC,BASFNCV1PR // prototypes for all #$ procedures
/Copy QSRC,APLSRVV1PR // prototypes for $ procedures used for template programs
/Copy QSRC,MSGDTLDZ_@ // auto generatde data structures for field attribute fields
/Copy QSRC,MSGDTLDZPR // Always include the prototype for the current program
/Copy QSRC,DCTVALBPPR
/Copy QSRC,DCTVALDPPR

Dcl-Ds filterDs extname('MSGDTLFZ') Inz End-DS;
...
Dcl-Proc Prompt;
  ...
  If CsrFld = 'ACVDES';
    // DCTVALDP('APLDCT':'ACVROW':pmEnmVal:pmEnmDes:pmKeyPressed);
