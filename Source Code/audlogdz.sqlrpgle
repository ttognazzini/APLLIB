...
Dcl-F AUDLOGFZ workstn infds(dspDs) UsrOpn;

/Copy QSRC,BASFNCV1PR // prototypes for all #$ procedures
/Copy QSRC,APLSRVV1PR // prototypes for $ procedures used for template programs
/Copy QSRC,AUDLOGDZ_@ // auto generatde data structures for field attribute fields
/Copy QSRC,AUDLOGDZPR // Always include the prototype for the current program

Dcl-Ds filterDs extname('AUDLOGFZ') Inz End-DS;
...
Dcl-Proc ValidateScreen;
  ...
  // * Sort By
  If srtCde<1 or srtCde>10;  // **CHANGE, set the maximum sort code here
