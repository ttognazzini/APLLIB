...
Dcl-Proc PositionSFL;
  ...
  If pos.IDXLIB <> '';
    SQLStmPos += ' ' + Where + ' ucase(IDXLIB) < uCase(''' + %trim(pos.IDXLIB) + ''')';
    Where = 'and';
  ElseIf pos.IDXNME <> '';
    SQLStmPos += ' ' + Where + ' ucase(IDXNME) < uCase(''' + %trim(pos.IDXNME) + ''')';
    Where = 'and';
  ElseIf pos.IDXTXT <> '';
    SQLStmPos += ' ' + Where + ' ucase(IDXTXT) < uCase(''' + %trim(pos.IDXTXT) + ''')';
    Where = 'and';
  ElseIf pos.IDXUNID <> '';
    SQLStmPos += ' ' + Where + ' ucase(IDXUNID) < uCase(''' + %trim(pos.IDXUNID) + ''')';
    Where = 'and';
  ElseIf pos.ACVDES <> '';
