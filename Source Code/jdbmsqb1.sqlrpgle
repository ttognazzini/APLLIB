**FREE
// This program sets up the Java environment needed to do MS SQL connections
// This was abstracted out so it did not have to duplciated in addtional programs
...
Dcl-Proc Main;
  ...
  Monitor;
    ...
    envVar= '/java/mssql-jdbc-12.10.1.jre8.jar';
    ...
    If envVar = '' or %scan(envVar:'-Dos400.stderr=') <> 0;
      envVar = '-Dos400.stderr=file:/tmp/JDBMSQB1.txt;';
    Else;
...
Dcl-Proc chk;
  ...
  Else;
    ...
    If  actual_acc <> required_acc and actual_acc <> allowed_acc;
      Return '0';
    EndIf;
  EndIf;
  Return '1';
